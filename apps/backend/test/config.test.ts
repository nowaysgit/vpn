...
describe('production config guard', () => {
  ...
  test('accepts explicit postgres production configuration', async () => {
    ...
    process.env.YANDEX360_SMTP_USERNAME = 'robot@example.com'
    process.env.YANDEX360_SMTP_PASSWORD = 'yandex-app-password'
    process.env.YANDEX360_FROM_EMAIL = 'robot@example.com'
